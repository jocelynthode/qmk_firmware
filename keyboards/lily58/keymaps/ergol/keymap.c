 ...
 * |      |      |      |      |      |      |                    |      |      |      |      |      |PrntSc|
 * |------+------+------+------+------+------|                    |------+------+------+------+------+------|
 * |      |      | Home |  Up  | End  | PgUp |                    |  /   |  7   |  8   |  9   |      |TRCKPS|
 * |------+------+------+------+------+------|                    |------+------+------+------+------+------|
 * |      |      | Left | Down | Right| PgDwn|-------.    ,-------|  -   |  4   |  5   |  6   |  0   |BRTUP |
 * |------+------+------+------+------+------|TRACKPR|    |TRACKFW|------+------+------+------+------+------|
 * |      |      |VolDwn|Mute  |VolUp |      |-------|    |-------|   ,  |  1   |  2   |  3   |  .   |BRTDWN|
 * `-----------------------------------------/       /     \      \-----------------------------------------'
 *                   | LGUI | LGUI |Space | / Ctrl  /       \ Ctrl \  |Space | RAlt | RGUI |
 *                   |      |      |      |/       /         \      \ |      |      |      |
 *                   `----------------------------'           '------''--------------------'
 */
[_NAVNUM] = LAYOUT(
...
layer_state_t layer_state_set_user(layer_state_t state) {
  return update_tri_layer_state(state, _NAVNUM, _FKEYS, _ADJUST);
}
