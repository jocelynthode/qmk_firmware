...
const uint16_t PROGMEM jk_combo[] = {RCTL_T(KC_J), RSFT_T(KC_K), COMBO_END};
combo_t key_combos[] = {
 ...
 * `-----------------------------------------/       /     \      \-----------------------------------------'
 *                   | XXXXXXX| XXXXXXX |LOWER | /Space  /       \Enter \  |RAISE |BackSP| RAlt |
 *                   |      |      |      |/       /         \      \ |      |      |      |
 *                   `----------------------------'           '------''--------------------'
 */
 [_QWERTY] = LAYOUT(
  ...
  XXXXXXX,  LALT_T(KC_A),   LGUI_T(KC_S),    LSFT_T(KC_D),    LCTL_T(KC_F),    KC_G,                     KC_H,    RCTL_T(KC_J),    RSFT_T(KC_K),    RGUI_T(KC_L),    LALT_T(KC_SCLN), KC_QUOT,
  XXXXXXX,  KC_Z,   KC_X,    KC_C,    KC_V,    KC_B, KC_LBRC,  KC_RBRC,  KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH,  KC_RSFT,
                        KC_LALT, KC_LGUI, LT(_LOWER,KC_TAB), LSFT_T(KC_SPC), RSFT_T(KC_ENT), LT(_RAISE,KC_BSPC), KC_RALT, KC_DEL
),
/* LOWER
 * ,-----------------------------------------.                    ,-----------------------------------------.
 * |      |      |      |      |      |      |                    |      |      |      |      |      |      |
...
[_RAISE] = LAYOUT(
  ...
  KC_F1,  KC_F2,    KC_F3,   KC_F4,   KC_F5,   KC_F6,                       KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT, XXXXXXX, KC_PAGE_DOWN,
 ...
 */
  ...
  KC_LCTL,  KC_Z,   KC_X,    KC_C,    KC_V,    KC_B, KC_LBRC,  KC_RBRC,  KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH,  KC_RSFT,
                        KC_LALT, KC_LGUI, MO(_LOWER), KC_SPC, KC_ENT, MO(_RAISE), KC_BSPC, TG(_GAMING)
  )
};
